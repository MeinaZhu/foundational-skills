...
# sci_data <- read_csv (here("data", "sci-online-classes"))
sci_data <- read_csv ("data/sci-online-classes.csv")
  
# ggplot(data=sci_data)+
#    geom_count(mapping=aes(x=Gender, y=semester))

 
sci_data %>% 
   count(Gender, semester) %>% 
   ggplot(mapping = aes(x = Gender, y = semester)) +
     geom_tile(mapping = aes(fill = n))+
     labs(title="Students' genders in each semester",
          caption="What do you find from this visualization?")
...
library(here)
sci_data %>% 
  ggplot(mapping = aes(x = TimeSpent, y = total_points_earned, color = "red"))+
   geom_point() +
   geom_smooth(method = lm)+
     labs(title="Students' points and time spent on learning",
          caption="What do you find from this visualization?")
